package co.msingh.android.sunshine.sync;
...
import co.msingh.android.sunshine.R;
import co.msingh.android.sunshine.Utility;
...
//        Log.d(LOG_TAG, "onPerformSync Called.");
        Toast.makeText(getContext(), "performing sync", Toast.LENGTH_LONG).show();
